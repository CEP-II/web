...
const MyComponent = () => {
 ...
 <div className={styles.color_topbar} style={{ position: 'absolute', top: '0%', left: '0%', width: '100%', height: '12%' }}>
  ...
  {/* button to log out */}
  <button className="btn btn-primary" style={{ position: 'absolute', top: '30%', right: '3%', height: '40%', width: '10%', fontSize: '1vw' }} onClick={() => {
  ...
  {timeStamps.map((item, index) => {
    ...
    return (
      ...
      >
        ...
        <p style={{ fontSize: '1.2rem', margin: '0.5rem 0', whiteSpace: 'nowrap' }}>Position: {item.position}</p>
